...
class Notification(models.Model):
    ...
    title = models.CharField(max_length=200, help_text=_("Short notification title"))
    message = models.TextField(help_text=_("Detailed notification message"))
    ...
    is_read = models.BooleanField(
        default=False, help_text=_("Whether the notification has been read")
    )
    is_sent = models.BooleanField(
        default=False, help_text=_("Whether the notification has been sent/delivered")
    )
    ...
    read_at = models.DateTimeField(
        null=True, blank=True, help_text=_("When the notification was read")
    )
    sent_at = models.DateTimeField(
        null=True, blank=True, help_text=_("When the notification was sent")
    )
    ...
    icon = models.CharField(
        max_length=50, default="bell", help_text=_("Font Awesome icon name")
    )
    color = models.CharField(
        max_length=20, default="primary", help_text=_("Bootstrap color class")
    )
...
class NotificationPreference(models.Model):
    ...
    email_progress_updates = models.BooleanField(
        default=True, help_text=_("Receive email for progress updates")
    )
    email_course_completion = models.BooleanField(
        default=True, help_text=_("Receive email for course completions")
    )
    email_achievements = models.BooleanField(
        default=True, help_text=_("Receive email for achievements")
    )
    email_announcements = models.BooleanField(
        default=True, help_text=_("Receive email for announcements")
    )
    email_reminders = models.BooleanField(
        default=True, help_text=_("Receive email for reminders")
    )

    # In-App Notifications
    app_progress_updates = models.BooleanField(
        default=True, help_text=_("Show in-app progress notifications")
    )
    app_course_completion = models.BooleanField(
        default=True, help_text=_("Show in-app completion notifications")
    )
    app_achievements = models.BooleanField(
        default=True, help_text=_("Show in-app achievement notifications")
    )
    app_announcements = models.BooleanField(
        default=True, help_text=_("Show in-app announcements")
    )
    app_reminders = models.BooleanField(
        default=True, help_text=_("Show in-app reminders")
    )
    ...
    quiet_hours_start = models.TimeField(
        null=True, blank=True, help_text=_("Start of quiet hours (no notifications)")
    )
    quiet_hours_end = models.TimeField(
        null=True, blank=True, help_text=_("End of quiet hours")
    )
...
def create_progress_notification(student, video, progress_percentage):
    ...
    if progress_percentage >= 50 and progress_percentage < 90:
        ...
        message = (
            f"You're {progress_percentage:.0f}% through '{video.title}'. Keep going!"
        )
...
def create_completion_notification(student, video):
    ...
    title = "🎉 Congratulations! Video completed!"
