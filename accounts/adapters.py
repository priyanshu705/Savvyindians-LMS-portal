...
class CustomSocialAccountAdapter(DefaultSocialAccountAdapter):
    ...
    def pre_social_login(self, request, sociallogin):
        ...
        if user.email:
            try:
                ...
                logger.info(
                    f"Connected social account to existing user: {existing_user.email}"
                )
    ...
    def save_user(self, request, sociallogin, form=None):
        ...
        messages.success(
            request,
            _(
                "Welcome to our Learning Management System! Your student account has been created successfully."
            ),
        )
    ...
    def authentication_error(
        ...
        messages.error(
            request,
            _(
                "There was an error connecting to your Google account. Please try again or contact support if the problem persists."
            ),
        )
