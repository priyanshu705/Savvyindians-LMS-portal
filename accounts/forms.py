        ...
        if username_or_phone is not None and password:
            ...
            try:
                ...
                if re.match(r'^[\d\s\+\-\(\)]+$', username_or_phone):
                    ...
                    if not user:
                        raise forms.ValidationError(
                            _("No account found with this phone number. Please check and try again."),
                    ...
                    if not user:
                        raise forms.ValidationError(
                            _("No account found with this email. Please register first or check your email address."),
                ...
                if not user.is_student:
                    raise forms.ValidationError(
                        _("This login is only for bootcamp participants. Please use the correct login page."),
                        code='not_student',
                    )
                ...
                if self.user_cache is None:
                    raise forms.ValidationError(
                        _("Invalid password. Please check your password and try again."),
