...
# Custom apps - include full project apps so real project works
PROJECT_APPS = [
...
# Helpful third-party apps used across the project
EXTRA_THIRD_PARTY_APPS = [
    # Filtering support
    "django_filters",
...
# Combine all apps
INSTALLED_APPS = DJANGO_APPS + THIRD_PARTY_APPS + EXTRA_THIRD_PARTY_APPS + PROJECT_APPS
...
if DATABASE_URL:
    ...
    # Parse DATABASE_URL without automatic SSL enforcement
    DATABASES = {
        "default": dj_database_url.config(
            default=DATABASE_URL,
            conn_max_age=0,  # Disable connection pooling completely
            conn_health_checks=False,  # Disable health checks
        )
    }
    
    # Configure SSL for Render PostgreSQL
    # Using 'allow' mode which doesn't enforce SSL but will use it if available
    # This prevents SSL handshake/decryption errors
    DATABASES["default"]["OPTIONS"] = {
        "sslmode": "allow",  # Most permissive SSL mode
...
# Simplified to English only for bootcamp platform

LANGUAGE_CODE = "en-us"

TIME_ZONE = "UTC"

USE_I18N = False  # Disabled multi-language support
